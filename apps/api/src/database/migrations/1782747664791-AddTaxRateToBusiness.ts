...
export class AddTaxRateToBusiness1782747664791 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_0eddfeffadbe29bec8750d589c" ON "bills"  ("tab_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_29171753dda776dfb0037dba05" ON "menu_items"  ("branch_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_03ef7c5c41b4fa6d62d27d47f4" ON "orders"  ("tab_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_6290f6ba23d55826e9deaceee5" ON "orders"  ("menu_item_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4d5057e0cdbd1407b60216df6e" ON "tabs"  ("branch_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_1e4fa66a2d59fde6dbb07fb13a" ON "tabs"  ("table_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_2b477b0f678402fb70905e3aed" ON "tabs"  ("waiter_id") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_283e6bfdd38a7cc7fec643f72b" ON "tables"  ("branch_id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_ebe158ed365131baec7dccaae5" ON "tables"  ("branch_id", "table_number") `);
        await queryRunner.query(`ALTER TABLE "inventory_items" ADD CONSTRAINT "FK_4901ce8da083204cdc424cd85e5" FOREIGN KEY ("menu_item_id") REFERENCES "menu_items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "inventory_items" DROP CONSTRAINT "FK_4901ce8da083204cdc424cd85e5"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cddc0af590dd113d6e5b6b530c"`);
        await queryRunner.query(`DROP TABLE "shifts"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_62c2e5d5f2e6d35d04a651796f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4901ce8da083204cdc424cd85e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_687d174ee41f46d2ee4b0a241a"`);
        await queryRunner.query(`DROP TABLE "inventory_items"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_37c4270994f24036b3fbe40ce8"`);
