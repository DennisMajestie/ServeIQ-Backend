...
export class AddTaxRateToBusiness1782747664791 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."stock_movements_movement_type_enum" AS ENUM('purchase', 'sale', 'adjustment', 'wastage')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_37c4270994f24036b3fbe40ce8" ON "stock_movements"  ("inventory_item_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_687d174ee41f46d2ee4b0a241a" ON "inventory_items"  ("branch_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_4901ce8da083204cdc424cd85e" ON "inventory_items"  ("menu_item_id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_62c2e5d5f2e6d35d04a651796f" ON "inventory_items"  ("branch_id", "menu_item_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cddc0af590dd113d6e5b6b530c" ON "shifts"  ("branch_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "businesses" ADD "tax_rate" numeric(5,2) NOT NULL DEFAULT '7.5'`);
        await queryRunner.query(`ALTER TABLE "businesses" ADD "timezone" character varying NOT NULL DEFAULT 'Africa/Lagos'`);
